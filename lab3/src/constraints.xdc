...
set_property IOSTANDARD LVCMOS33 [get_ports motor_cw_1]
set_property IOSTANDARD LVCMOS33 [get_ports motor_ccw_1]
...
create_clock -period 10.000 -waveform {0.000 5.000} [get_ports refclk]
