...
HD_PWD='M:/pc/work/inf4431/lab3/src/test_pos_meas/test_pos_viv/test_pos_viv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pos_meas.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_pos_meas.tcl -notrace
