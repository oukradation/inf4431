...
HD_PWD='M:/pc/work/inf4431/lab3/src/test_pos_meas/test_pos_viv/test_pos_viv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pos_meas.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_pos_meas.tcl
