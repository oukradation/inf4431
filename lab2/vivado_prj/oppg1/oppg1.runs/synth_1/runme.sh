...
HD_PWD='M:/pc/work/inf4431/lab2/vivado_prj/oppg1/oppg1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pargen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pargen.tcl
