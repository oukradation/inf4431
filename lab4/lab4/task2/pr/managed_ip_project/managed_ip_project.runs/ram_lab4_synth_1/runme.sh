...
HD_PWD='M:/pc/work/inf4431/lab4/lab4/task2/pr/managed_ip_project/managed_ip_project.runs/ram_lab4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_lab4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_lab4.tcl
