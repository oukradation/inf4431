...
HD_PWD='/uio/hume/student-u41/wonhol/pc/work/inf4431/lab4/lab4/task1/task1_project_2/task1_project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compute_pipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compute_pipelined.tcl
